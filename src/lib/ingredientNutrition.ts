...
export type IngredientMacros = MassVolumeIngredientMacros | PerUnitIngredientMacros;
...
export function ingredientMacrosForAmount(ingredient: IngredientMacros) {
  return {
